...
INSERT INTO "new_Pick" ("confidence", "createdAt", "critiqueNotes", "critiqued", "dataGaps", "degradedAnalysis", "discrepancies", "eventId", "id", "keyFactors", "marketType", "modelName", "modelProvider", "outcome", "preCritiqueConfidence", "preCritiqueReasoning", "preCritiqueRecommendation", "reasoning", "recommendation", "runnerUp", "searchesPerformed", "searchesUsed", "settledAt") SELECT "confidence", "createdAt", "critiqueNotes", "critiqued", "dataGaps", "degradedAnalysis", "discrepancies", "eventId", "id", "keyFactors", "marketType", "modelName", "modelProvider", "outcome", "preCritiqueConfidence", "preCritiqueReasoning", "preCritiqueRecommendation", "reasoning", "recommendation", "runnerUp", "searchesPerformed", "searchesUsed", "settledAt" FROM "Pick";
DROP TABLE "Pick";
